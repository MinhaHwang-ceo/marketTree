...
public class KakaoAPI {
    ...
    private final static String CLIENT_ID = "c29af8a8adfc0e089b9fd1d54a273733";
    private final static String CLIENT_SECRET = "gZW0bIUreTCB3STiOEo45omXXd756MVk";
    /**/
    private final static String REDIRECT_URI = "https://www.weconn.co.kr/kakao";
    private final static String REDIRECT_SIGN_UP_URI = "https://www.weconn.co.kr/kakaoSignUp";
    private final static String REDIRECT_LINK_URI = "https://www.weconn.co.kr/kakaoLink";
    /**/
    /*
    private final static String REDIRECT_URI = "https://www.weconn.co.kr/kakao";
    private final static String REDIRECT_SIGN_UP_URI = "https://www.weconn.co.kr/kakaoSignUp";
    ...
    */
    ...
    public String getAccessToken (String authorize_code, HttpSession session) {
        String access_Token = "";
