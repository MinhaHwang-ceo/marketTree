  ...
  var feWorksheet = {
    init: function(options) {
      ...
      return this.each(function() {
        ...
        $(opt.workseetEl).feWorksheet('setNavi', opt).feWorksheet('setNumber', opt).feWorksheet('reflectDepth', opt).find('td.' + opt.nameCellClass).feWorksheet('_linkPath', opt);
    ...
    setNumber: function(opt) {
      return this.each(function() {
        ...
        $this.find('thead tr').prepend(_theadCellCode).end().find('tbody tr').each(function() {
    ...
    reflectDepth: function(opt) {
      return this.each(function() {
        ...
        $tbodyTrEl.each(function() {
          $(this).find($depthCell).each(function() {
    ...
    delayInfo: function(opt) {
      return this.each(function() {
        ...
        if (dDate == '' || !dFormat.test(dDate)) $this.addClass(opt.delayError);
    ...
    _taskSetPage: function(opt) {
      return this.each(function() {
        var $this = $(this),
          ...
          _footerCode = '<footer>' + '<h2>' + opt.totalCountTitle + '</h2>' + '<table>' + '<caption>' + opt.totalCountCaption + '</caption>' + '<thead>' + '<tr>' + '<th scope="col">Menu</th>' + '<th scope="col">Total</th>' + '</tr>' + '</thead>' + '<tbody></tbody>' + '<tfoot><th scope="row">Total</th></tfoot>' + '</table>' + '</footer>';
        ...
        $.each(taskKeyArray, function(idx, val) {
          var $footerEl = $('footer'),
            ...
            _footerThead = '<th scope="col">' + '<i>' + taskNameArray[idx] + '</i>' + '<b>' + val + '</b>' + '</th>';
          $footerEl.find('thead th:last').before(_footerThead).end().find('tfoot tr').append('<td>' + taskSum + '</td>');
        });
        $('footer').find('tfoot tr').append('<td>' + $('td.' + opt.taskCellClass).size() + '</td>');
    ...
    _taskSetTable: function(opt, taskKeyArray, taskNameArray) {
      return this.each(function() {
        var $this = $(this),
          ...
          _totalCode = '<tr>' + '<th scope="row" colspan="' + colSpanSize + '">' + 'Total' + '</th>' + '<td>' + totalSize + '</td>' + '</tr>',
        ...
        $.each(taskKeyArray, function(idx, val) {
          var tgTaskSize = $taskCell.filter('[data-task=' + val + ']').size(),
            ...
            _tfootCode = '<tr>' + '<th scope="row" colspan="' + colSpanSize + '">' + '<i>' + taskNameArray[idx] + '</i>' + '<b>' + val + '</b>' + '</th>' + '<td>' + tgTaskSize + '</td>' + '</tr>';
    ...
    _linkPath: function(opt) {
      return this.each(function() {
        var $this = $(this),
          ...
          folderPath = $this.siblings('.' + opt.pathCellClass).text().trim(),
          newPath;
